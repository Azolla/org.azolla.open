...
/**
 * The coder is very lazy, nothing to write for this ModelHelper class
 *
...
{
	private static final LoadingCache<Class<?>, JAXBContext>	MAPPING	= CacheBuilder.newBuilder().softValues()
	...
	public static <T> T unmarshal(Class<?> clazz, String filePath)
	{
		try
		{
